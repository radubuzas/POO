...
Videoclip::Videoclip(const std::string &title_, const std::string &description_, unsigned const & duration_) : title{title_}, description{description_}, duration{duration_} {
    viewCount = 0;
}
